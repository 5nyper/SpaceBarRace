...
N_NIMCALL(NI, rawparseint_116714)(NimStringDesc* s, NI64* b, NI start);
...
STRING_LITERAL(TMP272, "overflow", 8);
	...
	nimln(200, "parseutils.nim");
	{
		...
		(*b) = IL64(0);
		{
			...
			while (1) {
				...
				TMP265 = mulInt64((*b), IL64(10));
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP266 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP267 = subInt64((NI64)(TMP265), ((NI64) ((NI)(TMP266))));
				(*b) = (NI64)(TMP267);
		...
		TMP270 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP270);
		nimln(207, "parseutils.nim");
		TMP271 = subInt(i, start);
		result = (NI)(TMP271);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = rawparseint_116714(s, (&res), start);
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(228, "parseutils.nim");
	{
		...
		e_116855 = (Overflowerror3443*) newObj((&NTI23401), sizeof(Overflowerror3443));
		(*e_116855).Sup.Sup.Sup.m_type = (&NTI3443);
		nimln(2266, "system.nim");
		LOC9 = 0;
		LOC9 = (*e_116855).Sup.Sup.message; (*e_116855).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP272));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		nimln(230, "parseutils.nim");
		raiseException((Exception*)e_116855, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
